  ...
  return (
    ...
    >
      <div className="flex items-center whitespace-nowrap">
        <div className="text-lg tracking-wide uppercase rotate-90">{month}</div>
        <div className="text-5xl -ml-1">{day}</div>
        <div className="h-8">
          <svg
...
export default function CustomDatePicker({ setSelectedDate, date }) {
